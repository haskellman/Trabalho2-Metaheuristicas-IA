...
def playGame():
    ...
    while run:
        ...
        if GAME_MODE == "HUMAN_MODE":
            ...
            userInput = aiPlayer.keySelector(distance, obHeight, game_speed)
...
from Trab2_Israel_dos_santos_candeias import my_classifier, genetic

def evaluation_func(state):
    global aiPlayer
    aiPlayer = my_classifier(state)
...
def main():
    ...
    initial_state = [0, 1, 0, -60, -1, 0, 33, -80, -100, 1]
    aiPlayer = my_classifier(initial_state)
    # best_state = genetic (evaluation_func, initial_state, 50, 0.9, 0.1, 86400, 20)[0]
    # print (best_state)
    # aiPlayer = my_classifier(best_state)
    res, value = manyPlaysResults(30)
